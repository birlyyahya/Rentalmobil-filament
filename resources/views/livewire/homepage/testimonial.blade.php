                        ...
                        <div class="mb-8 sm:break-inside-avoid">
                            <blockquote class="p-6 rounded-lg shadow-sm bg-gray-50 sm:p-8">
                                ...
                                <p class="mt-4 text-gray-700">
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus eveniet qui facilis quam eum, illum in officiis magnam repudiandae sint!
                                </p>
                            </blockquote>
                        </div>
                        <div class="mb-8 sm:break-inside-avoid">
                            <blockquote class="p-6 rounded-lg shadow-sm bg-gray-50 sm:p-8">
                                ...
                                <p class="mt-4 text-gray-700">
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Provident doloribus in culpa soluta aliquam, excepturi, deleniti eius dolorem consectetur ipsam esse ab voluptatibus natus incidunt quam molestias tempora laboriosam. Assumenda eos fuga doloribus ratione obcaecati ut voluptates, explicabo molestias optio.
                                </p>
                            </blockquote>
                        </div>
                        <div class="mb-8 sm:break-inside-avoid">
